"""
Basic usage example for Gitlab MCP Server.
...
Prerequisites:
- Install the package: pip install gitlab-mcp-server
...
async def example_usage():
    """
    Example usage of Gitlab MCP Server.
...
if __name__ == "__main__":
    ...
    print("\n" + "="*60)
    print(f"  Gitlab MCP Server - Basic Usage Example")
    print("="*60 + "\n")
    ...
    try:
        ...
        print("2. All dependencies are installed: pip install gitlab-mcp-server")
